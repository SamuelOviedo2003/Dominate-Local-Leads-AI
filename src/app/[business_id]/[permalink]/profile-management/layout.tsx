...
interface PermalinkProfileManagementLayoutProps {
  children: ReactNode
  params: { permalink: string }
}

/**
 * Profile Management layout for permalink-based routes
 ...
 */
export default async function PermalinkProfileManagementLayout({ 
  children,
  params 
}: PermalinkProfileManagementLayoutProps) {
  ...
  if (!user) {
    console.error('[PROFILE_MANAGEMENT_LAYOUT] No authenticated user found - this should not happen after permalink layout validation')
    return null
  }
