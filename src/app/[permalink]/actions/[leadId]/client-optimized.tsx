...
// Unified loading component for the entire Actions page
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="flex items-center justify-center py-16">
            <ComponentLoading message="Loading actions and lead details..." />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Note: ActionsChecklist handles its own loading state for actions API call */}
          <div className="w-full">
            <ActionsChecklist
              leadId={leadId}
              businessId={businessId}
...
export default memo(ActionsPageOptimized)