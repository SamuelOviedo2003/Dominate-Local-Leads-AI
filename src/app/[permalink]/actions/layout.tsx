...
/**
 * Actions layout for permalink-based routes
 ...
 */
export default async function PermalinkActionsLayout({
  children,
  params
  ...
  if (!user) {
    console.error('[ACTIONS_LAYOUT] No authenticated user found - this should not happen after permalink layout validation')
    return null
  }
