...
// Unified loading component for the entire Property Details page
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-red-50 border border-red-200 rounded-md p-6">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">Error Loading Property Details</h3>
...
const PropertyDetailsPageOptimized = () => {
...
export default memo(PropertyDetailsPageOptimized)