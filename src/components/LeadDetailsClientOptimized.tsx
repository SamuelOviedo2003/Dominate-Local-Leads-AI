 ...
 */
export function LeadDetailsClientOptimized() {
  const { user } = useAuthData()

  console.log('[LEAD_DETAILS_CLIENT_OPTIMIZED] Using cached auth data from context')
