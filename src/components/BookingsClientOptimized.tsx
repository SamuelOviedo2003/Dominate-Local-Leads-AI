...
/**
 * Optimized wrapper for BookingsClient that uses cached authentication data
 * Eliminates the need to pass auth props - gets data from AuthDataProvider
 */
export function BookingsClientOptimized() {
  const { user } = useAuthData()

  console.log('[BOOKINGS_CLIENT_OPTIMIZED] Using cached auth data from context')
  ...
  // Pass cached data to the original BookingsClient
