...
function FollowUpTableComponent({
  leads,
  isLoading,
  error,
  ...
  // Helper function to get purpose tag styling (similar to how_soon)
  ...
  if (error) {
    return (
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          <div className="text-red-500 text-sm">Error loading follow up leads: {error}</div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow">
      ...
      {isLoading ? (
        ...
        <div className="p-6">
          <div className="text-gray-500 text-center py-8">No follow up leads found for the selected period</div>
        </div>
      )}
    </div>
  )
...
export const FollowUpTable = memo(FollowUpTableComponent)