...
function RecentLeadsTableComponent({
  leads,
  isLoading,
  error,
  ...
  if (error) {
    return (
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          <div className="text-red-500 text-sm">Error loading recent leads: {error}</div>
        </div>
      </div>
    )
  }
...
export const RecentLeadsTable = memo(RecentLeadsTableComponent)